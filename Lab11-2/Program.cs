...
namespace ASD
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            List<Geometry.Segment> testSegment9 = new List<Geometry.Segment>();
            testSegment9.Add(new Geometry.Segment(new Geometry.Point(0, 4), new Geometry.Point(0, 1)));
            testSegment9.Add(new Geometry.Segment(new Geometry.Point(0, 2), new Geometry.Point(0, 3)));
            ...
            TestCaseBase[] tc = {
                ...
                new TestCaseSegment(testSegment9,3,0.0001),
            };
